...
select name from people where passport_number in(select passport_number from passengers where flight_id=(select id from flights where origin_airport_id=8
...
select name from people where id in (select person_id from bank_accounts where account_number in (select account_number from atm_transactions where year=2021
...
select destination_airport_id from flights where origin_airport_id=8 and year=2021 and month=7 and day=29 and id=(select id from flights where origin_airport_id=8
...
select city from airports where id=(select destination_airport_id from flights where origin_airport_id=8 and year=2021 and month=7 and day=29 and
...
select name from people where phone_number=(select receiver from phone_calls where year=2021 and month=7 and day=28 and duration<60 and caller=(select phone_number
